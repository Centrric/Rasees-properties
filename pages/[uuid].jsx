    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta name="description" content={`state: ${data.state}   city: ${data.city}    dimension: ${data.dimension}    Facing Towards: ${data.faced_towards}${data.plot_area ? `     Plot Area: ${data.plot_area}     plot Length: ${data.plot_length}     Plot Breadth: ${data.plot_breadth} ` : `       No. of Floors: ${data.no_of_floors}`}       Price : ${data.price}/${data.per_unit} ${data.description ? `Description: ${data.description} ` : ''} `} />
